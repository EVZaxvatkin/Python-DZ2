...
#     print(f"Минимальное число монет вверх гербом, которые необходимо переверуть: {M.count(0)}") 
#else:
#     print(f"Минимальное число монет решкой вверх, которые необходимо переверуть: {M.count(1)}")
...
s = [random.randint(1, v) for i in range(n)]
